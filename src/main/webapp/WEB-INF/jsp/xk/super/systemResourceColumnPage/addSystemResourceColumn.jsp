            ...
            <form id="tf" class="layui-form" action="">
                <div class="layui-form-item">
                    ...
                    <div class="layui-input-inline">
                        <input type="text" id="srcname" name="srcname" lay-verify="required|srcname" placeholder="请输入栏目名(小于10个字符)"
...
<script>
        ...
        form.on('submit(demo1)', function (formData) {
            ...
            var option = {
                ...
                success: function (data) {
                    if (data.code == 200) {
                        layer.msg("系统资源栏目添加成功");
                        setTimeout("checkContinueAddAdmin()", 500);
                    } else {
                        layer.msg("系统资源栏目添加失败! 失败原因:" + data.msg);
                    }
                }
            };
    ...
    function checkContinueAddAdmin() {
        layer.confirm('要继续添加栏目吗?', function(index){
            ...
            layer.close(index);
            //设置管理资源栏目为选中
            $("#oAddSystemResourceColumn").removeClass("layui-this");
            $("#oSystemResourceColumnControl").addClass("layui-this");
            loadPage("${pageContext.request.contextPath}/xk/super/systemResourceColumnPage/systemResourceColumnControl");
        });
    }
