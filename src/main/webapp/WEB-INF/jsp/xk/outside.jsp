            ...
            <ul class="layui-nav layui-nav-tree site-demo-nav">
                    ...
                    <li class="layui-nav-item">
                        ...
                        <dl class="layui-nav-child">
                            <dd id="oAddAdmin" style="text-align: center;">
                                <a href="javascript:void(0);" onclick="toLoadPage(this)" value="${pageContext.request.contextPath}/xk/super/adminPage/addAdmin">管理员添加</a>
                            </dd>
                            <dd id="oAdminControl" style="text-align: center;">
                                <a href="javascript:void(0);" onclick="toLoadPage(this)" value="${pageContext.request.contextPath}/xk/super/adminPage/adminControl">管理员管理</a>
                            </dd>
                        </dl>
                    </li>
                </c:if>
                ...
                <c:if test="${sessionScope.admin.alevel<=0}">
                    <li class="layui-nav-item">
                        ...
                        <dl class="layui-nav-child">
                            <dd style="text-align: center;">
                                <a href="${pageContext.request.contextPath}/xk/protect/indexConfig">主界面设置</a>
                            </dd>
                        </dl>
                    </li>
                </c:if>--%>
