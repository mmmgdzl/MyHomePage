...
<script>
    layui.use(['form', 'table'], function(){
        ...
        table.render({
            elem: '#table'
            ,url: '${pageContext.request.contextPath}/xk/protect/myResourceComment'
            ,toolbar: '#toolbarDemo'
            ,cols: [[
                {checkbox: true},
    ...
    function edit(id, rcenable) {
        ...
        $.ajax({
            ...
            ,success:function(data) {
                ...
                //成功与否都刷新页面
                setTimeout("loadPage('${pageContext.request.contextPath}/xk/protect/resourceCommentPage/myResourceCommentControl')", 500);
            }
        });
    }
